% --- Trains the network with some players and tests the model with the
% rest of the players it has been not trained on ---
% 
% --- To change the number trained on, alter line 18 to be the number of
% players (up to 672) to train ---
%
% --- To change the number of players to test on by altering line 32 (the
% second parameter) ---
